...
public class TestGame extends Test {
	...
	public void executeTests() {
		...
		try {
			...
			else { System.out.println("[ECHEC]"); this.fail(); }
		} catch (Exception e) {
		...
		System.out.print("Nombre de piles de reserve : ");
		this.reset();
		try {
		...
		System.out.print("Trouver une carte presente dans la reserve : ");
		this.reset();
		try {
		...
		System.out.print("Trouver une carte absente de la reserve : ");
		this.reset();
		try {
		...
		System.out.print("Retirer une carte de la reserve : ");
		this.reset();
		try {
		...
		System.out.print("Retirer une carte absente de la reserve : ");
		this.reset();
		try {
		...
		System.out.print("Partie non terminee : ");
		this.reset();
		try {
		...
		System.out.print("Piles de reserve disponibles : ");
		this.reset();
		try {
			boolean found;
			found = false;
